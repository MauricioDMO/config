...
### Step 2: Check for root-level `DESIGN.md`

Look for `DESIGN.md` at the root of the current project:
...
```
---
💡 **Tip:** For consistent designs across multiple screens, create a
root-level `DESIGN.md` file using the `taste-design` skill. This ensures all
generated pages share the same visual language.
```
...
---
💡 **Tip:** For consistent designs across multiple screens, create a
root-level `DESIGN.md` file using the `taste-design` skill.
```
